...
public:
    ReactiveFollowGap() : Node("reactive_node")
    {
        ...
        m_panic_dist = 0.4;//0.1;              // WHen to greedily go towards furthest point
        m_lidar_smoothing_kern_size = 2; // For preprocessing lidar
        m_far_thresh = 6.0f;//4.0f;                // Threshold for meters when something wont be considered
...
private:
    ...
    {   
        ...
        // IMPL: BETWEEN EDGE OF SAFETY AND FURTHEST POINT
        ...
        // NOTE: Not sure how good this is
        ...
        if (panic == 0.0f)
        {
             ...
             best_idx = best_idx + 3*overCorrect/4;
         }
